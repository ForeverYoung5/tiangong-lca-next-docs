...
lastReviewedNote: "Reviewed for PR #130 conflict resolution: four-locale CLI maintenance guidance remains within the existing public-content, validation, and workspace-integration boundaries."
related:
  - .docpact/config.yaml
