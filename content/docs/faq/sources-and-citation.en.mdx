...
See [Create My Data](/en/docs/user-guide/create-my-data/#create-a-source) for the detailed workflow.
...
- **Review checks** in [Data Review](/en/docs/user-guide/data-review/) flag missing or incomplete references before publication.
...
The platform regularly syncs new data and methods. Refer to the [Feature Updates](/en/docs/changelog/function-update/) page for release notes. Major changes are also announced via the message centre.
