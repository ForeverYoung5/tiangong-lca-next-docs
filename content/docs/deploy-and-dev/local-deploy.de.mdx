...
- `SMTP_*`: Die E-Mail-Konfiguration muss gesetzt werden, um E-Mail-Authentifizierung zu aktivieren (siehe [SMTP-Dienstanweisungen und Empfehlungen](#smtp-service-instructions--recommendations))
...
- [TianGong-LCA-Next-Projekt](https://github.com/linancn/tiangong-lca-next)
