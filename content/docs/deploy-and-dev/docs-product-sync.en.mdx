...
Public documentation explains what users can do; the product repository determines how the system actually works. Before changing a user flow, permission, route, API, or screenshot explanation, verify the current implementation in `../tiangong-lca-next`.

## Sources of truth

- Product behaviour: `../tiangong-lca-next`
