...
- Node.js 24.18 ou version ultérieure
- pnpm 11.22.0
- Git, utilisé pour produire une identité de source et des horodatages reproductibles

Le dépôt fixe sa chaîne d'outils avec `packageManager`, `engines` et le fichier de verrouillage. Ne mélangez pas les gestionnaires de paquets.
