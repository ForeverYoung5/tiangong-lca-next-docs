...
La documentation publique explique ce que les utilisateurs peuvent faire ; le dépôt produit détermine le comportement réel. Avant de modifier un parcours, une autorisation, une route, une API ou une explication visuelle, vérifiez l'implémentation actuelle dans `../tiangong-lca-next`.

## Sources de vérité

- Comportement produit : `../tiangong-lca-next`
