...
- `SMTP_*` : la configuration e-mail doit être définie pour activer l'authentification par e-mail (voir [Instructions et recommandations SMTP](#smtp-service-instructions--recommendations))
...
- [Projet Tiangong LCA Next](https://github.com/linancn/tiangong-lca-next)
