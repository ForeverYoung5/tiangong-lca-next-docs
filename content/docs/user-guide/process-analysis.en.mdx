...
- Use **Open data** when comparing published datasets. Process profiles and LCIA detail rows in
  ...
  snapshot / method / factor hashes, and downloadable artifacts; if that evidence is incomplete or
  blocked, Open Data analysis does not treat it as a publishable result.
