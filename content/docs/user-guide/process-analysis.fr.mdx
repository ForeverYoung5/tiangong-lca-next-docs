...
Il se distingue de la page habituelle [Calcul LCIA et résultats](./lcia/) :
...
dans [Import/export TIDAS ZIP et centre de tâches](./tidas-zip-workflows/).
...
- [Calcul LCIA et résultats](./lcia/)
- [Revue de données](./data-review/)
- [Autorisations et espaces de données](./permissions-and-data-scopes/)
