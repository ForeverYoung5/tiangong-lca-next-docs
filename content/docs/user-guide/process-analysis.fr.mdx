...
- Utilisez **Données ouvertes** pour comparer des jeux de données publiés. Les profils de processus
  ...
  couverture, les hachages snapshot / méthode / facteur et les artefacts téléchargeables ; si ces
  preuves sont incomplètes ou bloquées, l'analyse Données ouvertes ne les traite pas comme un
  résultat publiable.
