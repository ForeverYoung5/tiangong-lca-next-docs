...
For collaboration workflow details, also read [Team Functions](/en/docs/user-guide/team-function/).
...
If your task is review execution, continue with [Data Review](/en/docs/user-guide/data-review/).
...
For platform-level maintenance work, continue with [System Management Workspace](/en/docs/user-guide/system-management/).

## Data scopes inside Process Analysis

The [Process Analysis Workspace](/en/docs/user-guide/process-analysis/) introduces another scope layer that is related
