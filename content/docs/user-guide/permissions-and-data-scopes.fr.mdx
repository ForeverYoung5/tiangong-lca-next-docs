...
Pour les détails du workflow de collaboration, lisez aussi [Fonctions d'équipe](/fr/docs/user-guide/team-function/).
...
Si votre tâche est l'exécution des revues, poursuivez avec [Revue de données](/fr/docs/user-guide/data-review/).
...
Pour la maintenance au niveau plateforme, poursuivez avec [Espace d'administration système](/fr/docs/user-guide/system-management/).

## Périmètres de données dans l'analyse de processus

L'[Espace d'analyse de processus](/fr/docs/user-guide/process-analysis/) introduit une autre couche de périmètre,
