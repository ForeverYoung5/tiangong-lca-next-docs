...
- Nach Widerruf muss der Client erneut Browser-OAuth starten: `tiangong-lca auth login` für die CLI oder erneutes Verbinden des MCP-Hosts.
...
Der reversible Nutzer-API-Key ist ein ausgemusterter Kompatibilitätspfad, keine Einrichtung für neue Integrationen. Geben Sie KI oder externen Tools niemals Passwort, Autorisierungscode, Access-/Refresh-Token oder alten API-Key.
