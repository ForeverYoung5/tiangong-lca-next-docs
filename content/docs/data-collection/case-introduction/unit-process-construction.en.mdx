...
Reference for platform operations: [Create New Data - Create Process](/en/docs/user-guide/create-my-data/#create-process)
...
Reference for creating new flows: [Create New Data - Create Flow](/en/docs/user-guide/create-my-data/#create-flow)
