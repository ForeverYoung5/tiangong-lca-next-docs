...
新建单元过程的平台操作流程参考[新建数据-新建过程](/zh/docs/user-guide/create-my-data/#create-process)
...
![替代文字](/assets/docs/199ca293/dataset-description.png)
...
![替代文字](/assets/docs/27e0503e/process-chart.png)
...
![替代文字](/assets/docs/030e7011/reference-citation.png)
...
![替代文字](/assets/docs/0ea57770/data-set-generator.png)

![替代文字](/assets/docs/21dd8e32/data-entry-personnel.png)

![替代文字](/assets/docs/7ae801bd/data-set-version.png)
...
![替代文字](/assets/docs/bd904a1f/input-output-1.png)

【生物质气化】

当前过程存在输入输出**不平衡**，主要原因在于锅炉用水为系统内部循环使用，未作为最终排放计入输出流。需在**备注中予以说明**，以保证物料守恒逻辑清晰。

![替代文字](/assets/docs/a1f405d4/input-2.png)

![替代文字](/assets/docs/22ef0873/output-2.png)

例：<u>锅炉用水在系统中通过闭路循环重复利用（如气化、合成、冷凝回用），输入的水大部分参与内部化学反应与能量传递，最终通过回收纯化重新投入流程，因此输出列表未单独列出水的“消耗”。</u>

![替代文字](/assets/docs/11a83b19/water-usage-note.png)
...
![替代文字](/assets/docs/7cba249a/input-3.png)

![替代文字](/assets/docs/1781bb8c/output-3.png)

例：<u>考虑物料平衡，基于输入水量添加废水量以修正数据表。</u>

![替代文字](/assets/docs/eeb55e62/wastewater-note.png)
...
新建流的操作流程见[新建数据-新建流](/zh/docs/user-guide/create-my-data/#create-flow)

![替代文字](/assets/docs/b26cecf7/flow-name.png)

![替代文字](/assets/docs/7eeaec53/flow-information.png)

![替代文字](/assets/docs/96d03427/flow-modelling.png)

![替代文字](/assets/docs/70fe3d52/flow-administration.png)

为提升流数据的适用性与完整性，建议在填写流属性时尽量补充多个单位形式。对于甲醇等标准化工产品，可参考其他权威资料或文献，补充如密度、热值等关键参数，从而支持质量、体积、能量等不同建模需求。**并选定其中一个单位为参考量值。**

![替代文字](/assets/docs/d1b09081/flow-property.png)
...
![替代文字](/assets/docs/26082934/co2-natural-gas.png)

![替代文字](/assets/docs/ef5f8641/natural-gas-note.png)
