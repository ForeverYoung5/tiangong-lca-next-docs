...
Log in to the [Tiangong Life Cycle Data Platform](https://lca.tiangong.earth). For user registration and login guidance, please refer to the [official documentation](/en/docs/quick-start/first-login/). After successfully opening the page, perform the following operations.
