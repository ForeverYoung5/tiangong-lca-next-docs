...
Verwenden Sie die vom Betreiber für diesen Codex-Host registrierte öffentliche Client-ID und den exakten Loopback-Callback:
...
Codex öffnet den Browser und speichert das rotierende Refresh-Token lokal. Weicht sein Loopback-Callback vom registrierten Wert ab, muss der Betreiber das exakte Client-/Callback-Paar registrieren; aktivieren Sie nicht DCR und fügen Sie kein Bearer-Token ein.
