...
lastReviewedNote: "Reviewed for docs-impact Issue #651: lockfile-free installation, docs:llms, publication-scope, screenshot, lint, typecheck, and build commands remain current for CLI dataset maintenance docs."
related:
  - docs/dev/dev-env.md
