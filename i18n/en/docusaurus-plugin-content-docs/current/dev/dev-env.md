...
lastReviewedNote: "Reviewed for docs-impact Issue #562: lockfile-free installation, docs:llms, publication-scope, screenshot, lint, typecheck, and build commands remain current."
related:
  - docs/dev/dev-env.md
