...
lastReviewedNote: "Reviewed for Issue #165: public-content proof now includes a four-locale OAuth contract test and removal of retired password/API-key/demo screenshots, plus unchanged lint/link/static-build gates."
related:
  - AGENTS.md
  - .docpact/config.yaml
