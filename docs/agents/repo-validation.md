...
lastReviewedNote: "Reviewed for Issue #171: OAuth-only CLI, remote MCP, and account documentation remains gated by localized contract tests, lint, links, static build, and strict Docpact validation."
related:
  - AGENTS.md
  - .docpact/config.yaml
