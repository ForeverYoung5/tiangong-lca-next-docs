...
lastReviewedNote: "Reviewed for Issue #177: the four-locale Codex exact callback/client configuration is gated by focused OAuth tests, lint, links, build, and Docpact."
related:
  - AGENTS.md
  - .docpact/config.yaml
