...
lastReviewedNote: "Reviewed for Issue #175: the four-locale direct Supabase JWT MCP contract and retired-broker denylist are gated by focused tests, lint, links, build, and strict Docpact validation."
related:
  - AGENTS.md
  - .docpact/config.yaml
