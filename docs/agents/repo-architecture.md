...
lastReviewedNote: "Reviewed for PR #130 conflict resolution: next-docs still owns four-locale public CLI content while CLI behavior remains sourced from tiangong-lca/tiangong-cli."
related:
  - AGENTS.md
  - .docpact/config.yaml
