...
lastReviewedNote: "Reviewed for P1 skeleton (issue #131): production app is Fumadocs 16 static export at repo root; EdgeOne Makers owns build+deploy; docs/ + i18n/ are frozen migration inputs until P2 completes."
related:
  - AGENTS.md
  - .docpact/config.yaml
