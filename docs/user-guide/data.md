...
- 是数据编写与维护的主要工作区，可创建模型、过程、流、来源、联系人等对象。单位组和流属性属于基础配置，新增或补充通常由系统管理员处理；普通用户如需补充，请联系管理员。  
...
`*` 单位组与流属性的新增、导入、复制等维护入口仅系统管理员可用。若页面提示“需要新增或补充单位组？请联系管理员。”或“需要新增或补充流属性？请联系管理员。”，请先联系管理员完成基础配置维护。
