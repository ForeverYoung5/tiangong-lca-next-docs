...
4. 查看历史版本：列表默认按同一数据 UUID 聚合并显示当前可见范围内的最新版本；点击版本旁的“所有版本”键，可在抽屉中查看该数据的历史版本。
5. 查看历史版本数据：在“所有版本”抽屉中点击相应历史版本右侧的“查看”键，可查看历史数据的详细信息。若抽屉支持单选，选中目标版本后点击“保存”即可引用该版本。
 ![](./img/open1.png)
