...
lastReviewedNote: "Reviewed for docs-impact Issue #561: lockfile-free install, docs:llms, publication-scope, screenshot, lint, typecheck, and build workflow remain current."
related:
  - AGENTS.md
