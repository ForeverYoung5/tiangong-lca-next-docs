...
lastReviewedNote: "Reviewed for docs-impact Issue #651: CLI dataset maintenance guidance was updated directly, so no new product/docs drift backlog item is needed."
related:
  - AGENTS.md
  - README.md
