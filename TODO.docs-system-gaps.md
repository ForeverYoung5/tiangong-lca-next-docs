...
lastReviewedNote: "Reviewed for docs-impact Issue #619 after rebasing current main into PR #129: TIDAS import validation guidance was updated directly, so no new product/docs drift backlog item is needed."
related:
  - AGENTS.md
  - README.md
